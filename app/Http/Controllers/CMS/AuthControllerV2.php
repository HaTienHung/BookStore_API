...
class AuthControllerV2 extends Controller
{
     ...
     * @author Hungha
     * @OA\Post (
     *     path="/api/auth/cms/login",
     *     tags={"Tài khoản CMS"},
     *     summary="Đăng nhập CMS",
     *     operationId="cms_login",
     *     @OA\Parameter(
     *          in="header",
     *          name="X-localication",
     *          required=false,
    ...
    public function login(Request $request): JsonResponse
    {
        try {
            ...
            $user = $this->user->ofEmail($request->email)
                ->ofRole([User::$publisher, User::$admin])
                ->first();
     ...
     * @author Nampx
     * @OA\Get (
     *     path="/api/auth/cms/logout",
     *     tags={"Tài khoản CMS"},
     *     summary="Đăng xuất",
     *     security={{"bearerAuth":{}}},
     *     operationId="cms_logout",
     *     @OA\Parameter(
     *          in="header",
     *          name="language",
     *          required=false,
     ...
     * @author Nampx
     * @OA\Post (
     *     path="/api/auth/cms/change-password",
     *     tags={"Tài khoản CMS"},
     *     summary="Đổi mật khẩu",
     *     security={{"bearerAuth":{}}},
     *     operationId="cms_change-password",
     *     @OA\Parameter(
     *          in="header",
     *          name="language",
     *          required=false,
    ...
    /**
     * @OA\Post(
     *     path="/api/auth/cms/send-verify-code",
     *     tags={"Tài khoản CMS"},
